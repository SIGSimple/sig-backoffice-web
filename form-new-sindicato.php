<div class="panel" ng-controller="CadastroSindicatoCtrl">
		...
		<div class="panel-body">
				...
				<label class="control-label col-lg-2">Nome</label>
					<div class="col-lg-4">
						<div class="input-group">
							<input type="text" class="form-control" readonly="readonly" value="{{ sindicato.empresa.nme_sindicato }}">
								<span class="input-group-btn">
									<button class="btn btn-default" type="button" ng-click="abreModal('sindicatos', 'empresa')">
			...
			<div class="form-group">
				<label class="control-label col-lg-2">Adicional Noturno</label>
					<div class="col-lg-4">
						<input type="text" class="form-control" ng-model="sindicato.num_percentual_adicional_noturno">
					</div>
			</div>
